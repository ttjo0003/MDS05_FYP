...
MODEL_CANDIDATES = [
    os.path.join(BASE_DIR, "best_sign_lstm_semantic_5glosses.pth"),
    os.path.join(BASE_DIR, "..", "model", "best_sign_lstm_semantic_5glosses.pth"),
]

LABEL_MAP_CANDIDATES = [
    os.path.join(BASE_DIR, "label_map_semantic_5glosses.json"),
    os.path.join(BASE_DIR, "..", "model", "label_map_semantic_5glosses.json"),
]
